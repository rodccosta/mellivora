...
$lang['sorry'] = 'Desculpe';
$lang['after_release'] = 'Após lançamento';
...
$lang['account_signup_information'] = 'Seu time compartilha uma mesma conta. {password_information}';
$lang['team_name'] = 'Nome do time';
$lang['select_team_type'] = 'Por favor, selecione seu tipo de time';
...
$lang['invalid_team_type'] = 'Isso não parece um tipo de time válido.';
$lang['team_name_too_long_or_short'] = 'O nome do seu time é muito curto ou muito longo.';
...
$lang['user_already_exists'] = 'Uma conta com seu nome de time ou email já cadastrado no sistema.';
$lang['signup_successful'] = 'Login feito com sucesso';
$lang['signup_successful_text'] = 'Obrigado por registrar-se! Seu email escolhido é: {email}. Tenha certeza de verificar sua caixa de spam e email por nosso email pode
ter sido colocada nela. Fique ligado pois novas atualizações podem surgir!';
...
$lang['invalid_team_key'] = 'Chave de time inválida.';
...
$lang['challenge_not_solved'] = 'Esse desafio não foi resolvido por um de algum dos times.';
...
$lang['challenge_relies_on'] = 'Os detalhes deste desafio serão mostrados apenas depois {relies_on_link} no link {relies_on_category_link} quando a categoria for resolv
ida por um dos times.';
